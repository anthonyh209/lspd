...
max_degree = 60 # selecting the upper bound
...
limited_geometry = partial.limited_beam_geometry(space, num_angles=60, max_degree=max_degree) # defining a new function here
