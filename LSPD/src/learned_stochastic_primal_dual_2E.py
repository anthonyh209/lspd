"""LSPDF algorithm for 2+ Angle Epoch"""
...
print("positive ellipses and relu. new initialisation. weights given. Try3- 3")
...
#this transformation since changing the space for 2 angle epochs (or more)
